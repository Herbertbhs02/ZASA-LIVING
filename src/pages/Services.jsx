    ...
    <div className="">
      ...
      <div className="relative p-6 text-white bg-[url('/images/PersonalLifestyleSupport.png')] bg-cover bg-center bg-no-repeat">
        ...
        <div className="relative z-10">
          ...
          <p>
            Organising your travel is made easier, we book rail or airline
            tickets as well as accommodation at home or abroad.{" "}
          </p>
          <li>Admin</li>
          <p>
      ...
      <div className="relative p-6 mt-1 text-white bg-[url('/images/HouseholdManagement.png')] bg-cover bg-center bg-no-repeat">
        ...
        <div className="relative z-10">
          ...
          <p>
            ...
            providers on your behalf and or use your suggested services
            providers to get your home to the desired state. Undertaking a House
            MOT, Trades and Services persons coordination such as window
            cleaner, and running errands such as taking the pets to the vet all
      ...
      <div className="  relative p-6 mt-1 text-white bg-[url('/images/Property.png')] bg-cover bg-center bg-no-repeat">
        ...
        <div className="relative z-10">
          ...
          <p>
            ...
            service you required will shape the support we provide. Our services
            range from Project Managing works on your behalf to a Key Holding
            service that ensures that your commissioned work is completed even
            in your absence, or you don’t return to nasty surprises as we check
